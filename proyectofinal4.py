#cbtis 89
#Leilani kitzianeli avitia casarrubias
            ...
            for linea in archivo:
                if linea.strip():
                    ...
                    if len(datos) == 4:
                        ...
                        # sumar el total de cada línea
                        try:
                            total_general += float(datos[3])
                        except ValueError:
                            pass  # por si hay valores no numéricos
...
estilo.configure("TButton",
                 font=("Arial", 12),  # Fuente Arial de 12 puntos
                 padding=10,          # Relleno para los botones
                 background="#4169E1", # Azul Rey
